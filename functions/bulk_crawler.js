...
if (fs.existsSync(bundledYtDlp)) {
  ...
  const localYtDlp = 'C:\\Users\\G Shreeniketh\\AppData\\Local\\Programs\\Python\\Python313\\Scripts\\yt-dlp.exe';
  if (fs.existsSync(localYtDlp)) ytDlpPath = localYtDlp;
}

const pythonBin = isCloud ? 'python3' : 'C:\\Users\\G Shreeniketh\\AppData\\Local\\Programs\\Python\\Python313\\python.exe';
const galleryDlPath = (!isCloud && fs.existsSync('C:\\Users\\G Shreeniketh\\AppData\\Local\\Programs\\Python\\Python313\\Scripts\\gallery-dl.exe'))
  ? 'C:\\Users\\G Shreeniketh\\AppData\\Local\\Programs\\Python\\Python313\\Scripts\\gallery-dl.exe'
  : 'gallery-dl';
